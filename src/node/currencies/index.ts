...
export default function getCurrency(currency: string, wallet: any, providerUrl?: string, contractAddress?: string): NodeCurrency {
    switch (currency) {
        ...
        case "cosmos": {
            return new CosmosConfig({ name: "cosmos", ticker: "ATOM", providerUrl: providerUrl ?? "https://rpc.cosmos.network", wallet, localConfig: { prefix: "atom", "derivePath": "118", "fee": "2500", "denomination": "uatom", "decimals": 1e6 } })
        }
        case "akash": {
            return new CosmosConfig({ name: "akash", ticker: "AKT", providerUrl: providerUrl ?? "https://rpc.akash.forbole.com", wallet, localConfig: { prefix: "akash", "derivePath": "118", "fee": "100", "denomination": "uakt", "decimals": 1e6 } })
        }
        case "terra": {
            return new CosmosConfig({ name: "terra", ticker: "LUNA", providerUrl: providerUrl ?? "https://terra-rpc.easy2stake.com", wallet, localConfig: { prefix: "terra", "derivePath": "330", "fee": "1200", "denomination": "uluna", "decimals": 1e6 } })
        }
        case "ust": {
