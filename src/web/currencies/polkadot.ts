...
// export default class PolkadotConfig extends BaseWebCurrency {
...
//         const signRaw = this.signer.injector?.signer?.signRaw;
...
//             .transferKeepAlive(sender, amount.toString())
//             .paymentInfo(sender);
...
//             data.unsignedTx.signAndSend(this.signerInstance.polkaPair, { signer: injector.signer }, (data) => {
...
//         await web3Enable('Bundlr Web App');
